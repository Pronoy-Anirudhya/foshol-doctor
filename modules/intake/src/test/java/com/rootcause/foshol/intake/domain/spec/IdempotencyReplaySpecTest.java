...
class IdempotencyReplaySpecTest {
    ...
    void replayConflictAndFarmerMismatch() {
        ...
        RequestFingerprint fingerprint =
                RequestFingerprint.compute(farmer, crop, "", null, List.of(Sha256.ofUtf8("img")), null);
        ...
        RequestFingerprint otherHash =
                RequestFingerprint.compute(farmer, crop, "x", null, List.of(Sha256.ofUtf8("img")), null);
