...
@Service
public class AdvisoryApprovedEventHandler {

    private static final Logger log = LoggerFactory.getLogger(AdvisoryApprovedEventHandler.class);
    ...
    public AdvisoryApprovedEventHandler(
