...
@Service
public class CaseRejectedEventHandler {

    private static final Logger log = LoggerFactory.getLogger(CaseRejectedEventHandler.class);
    ...
    public CaseRejectedEventHandler(
