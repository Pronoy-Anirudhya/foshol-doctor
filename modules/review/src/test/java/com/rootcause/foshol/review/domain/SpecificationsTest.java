...
import com.rootcause.foshol.review.domain.spec.ClaimIsHeldBy;
import com.rootcause.foshol.review.domain.spec.RemediesBelongToDisease;
import com.rootcause.foshol.review.domain.spec.TaskIsClaimable;
import com.rootcause.foshol.review.domain.spec.TaskIsTerminal;
...
class SpecificationsTest {
    ...
    private static RemedyView remedy(UUID id, UUID diseaseId, RemedyType type, Integer phi) {
        return new RemedyView(id, diseaseId, type, "", List.of(), null, phi, "LOW", "LOW", "");
    }
}
