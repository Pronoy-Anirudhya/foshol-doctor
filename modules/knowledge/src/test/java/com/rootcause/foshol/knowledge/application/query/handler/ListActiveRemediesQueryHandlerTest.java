...
class ListActiveRemediesQueryHandlerTest {
    ...
    void returnsActiveRemediesInPortOrder() {
        ...
        RemedyReadModel a = new RemedyReadModel(
                first, disease, RemedyType.CULTURAL, "a", List.of("a"), null, null, "LOW", "LOW", "src", 1, null, null, null, null, null, null, null, null);
        RemedyReadModel b = new RemedyReadModel(
                second, disease, RemedyType.ORGANIC, "b", List.of("b"), null, null, "LOW", "LOW", "src", 2, null, null, null, null, null, null, null, null);
